...
export function GiftModal({
  ...
  return (
    ...
    >
      ...
      {/* Panel */}
      <div className="relative z-10 w-full max-w-[420px] rounded-3xl bg-[#f3eeea] p-5 shadow-xl sm:rounded-3xl">
        <div className="flex items-start justify-between gap-4">
          ...
          alt="gift_lunaDeMiel"
          className="mx-auto h-auto w-20 object-contain bg-title rounded-full items-center justify-center mt-3"
        />
            </h3>
          </div>
